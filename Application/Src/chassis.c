...
Motor_HandleTypeDef motor1 = {
    ...
    .IN1_Port = GPIOF, // 临时使用GPIOA替代GPIOF
    .IN1_Pin = GPIO_PIN_0,
    .IN2_Port = GPIOF, // 临时使用GPIOA替代GPIOF
    .IN2_Pin = GPIO_PIN_1,
    .STBY_Port = NULL,
    .STBY_Pin = 0,
    .pwm_max = 1000};
...
void Chassis_Motor_PIDControl_Init(void)
{
    ...
    // 设置电机和电机编码器的朝向
    wheelController1.motor_direction = -1;
    wheelController4.motor_direction = -1;
    wheelController3.encoder_direction = 1;
    wheelController4.encoder_direction = 1;
...
void Chassis_Motor_SetSpeed(float speed1, float speed2, float speed3, float speed4)
{
    ...
    WheelSpeed_Update(&wheelController3);
    WheelSpeed_Update(&wheelController4);
